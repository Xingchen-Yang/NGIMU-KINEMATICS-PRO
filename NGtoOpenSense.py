...
def readIMU(l, q):
    ...
    #receive_ports = [8163, 8185, 8100] #This number is very important for recognizing sensors
    receive_ports = [8103, 8101, 8102]
    ...
    while True:
        for udp_socket in receive_sockets:
            ...
            try:
                ...
                #message = osc_decoder.decode(data)[1]
                # 0 when no raw data being collected
